...
if __name__ == "__main__":
    ...
    # #print(f'summa smartfonov {smartphone_sum}')
    #
    ...
    #
    # # order
    # phone = Product("Samsung Galaxy S23 Ultra", "256GB, Серый цвет", 180000.0, 5)
    # iphone = Product("iPhone 15", "512GB, Gray", 210000.0, 3)
    #
    # # Категория
    # smartphones = Category("Смартфоны", "Мобильные телефоны")
    # smartphones.add_product(phone)
    # smartphones.add_product(iphone)
    #
    # # Заказ
    # order1 = Order(phone, 2)
    # order2 = Order(iphone, 1)
    #
    # # Вывод
    # print(smartphones)
    # print(order1)
